class Done extends Event {
    ...
    public Pair<Server, Event> execute(Server server) {
        ...
        Server newServer = server.updateIfFree(this.eventTime, this.customer).addRestTime(restTime)
            .setRest(restTime != 0.0).decrementInQueue();
    ...
    public String toString() {
        return String.format("%.3f", this.eventTime) + " " 
            + this.customer.toString() + " done serving by ";
    }
}
